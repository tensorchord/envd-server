...
func (err errConnectionFailed) Error() string {
	if err.host == "" {
		return "Cannot connect to the envd server. Is the envd server running on this host?"
	}
	return fmt.Sprintf("Cannot connect to the envd server at %s. Is the envd server running?", err.host)
}
